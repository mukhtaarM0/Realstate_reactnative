...
const ProCard5 = () => {
  return (
    ...
    <ul className="text-gray-700 mb-4">
      ...
      <li><strong>Xaafada:</strong> Manhal</li>
      <li><strong>Udhaw:</strong> Dhaqtarka</li>
      <li><strong>Cabirka:</strong> 12/12</li>
      <li><strong>Qiimaha:</strong> $14000</li>
