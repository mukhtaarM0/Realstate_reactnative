...
const PropertyPage3 = () => {
  ...
  <div className="bg-white shadow-lg rounded-lg p-6 mb-6">
    ...
    <ul className="text-gray-700 mb-4">
      <li><strong>Xaafada:</strong> afgooye</li>
      <li><strong>Udhaw:</strong> Laami iyo baska</li>
      <li><strong>Kakooban:</strong> 9 qol</li>
      <li><strong>Qiimaha:</strong> 90$</li>
